...
5. Existing `.claude/rules/*.md` files → coding conventions, architecture rules, review checklist references.
...
6. Architecture (derived from `/lib` folder structure + claude rules)
...
- Use `<details><summary>` collapse blocks for sections longer than 40 lines.
