...
import 'package:maxi_pocket/core/shared/utils/helpers_method.dart' show getAppointmentsWrapperCommitments;
...
class MaxiPocketAppointmentsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final AsyncValue<List<AppointmentEntity>> appointments = ref.watch(appointmentProvider);
    ...
    await showAlertDialog(
      ...
      onConfirm: () async {
        ...
        await ref
            ...
            .deleteCommitment(commonId: entity.id!, type: MaxiPocketExpensesType.appointments);
