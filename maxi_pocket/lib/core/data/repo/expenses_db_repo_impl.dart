...
import 'package:maxi_pocket/core/data/repo/source/dto/entity_dto_extensions.dart'
    show
        AppointmentEntityExtension,
        FinancingEntityExtension,
        SubscriptionEntityExtension;
...
class ExpensesDbRepoImpl implements ExpensesDbRepo {
  ...
  Future<void> clearAllRowsTableQuery() =>
      _expensesSource.clearAllRowsTableQuery();
  ...
  Future<void> updateQuery({
    ...
    switch (object) {
      case final AppointmentEntity appointment:
        await _expensesSource.updateQuery(
          commonId: commonId,
          object: appointment.toDto(),
        );
      case final SubscriptionEntity subscription:
        await _expensesSource.updateQuery(
          commonId: commonId,
          object: subscription.toDto(),
        );
      case final FinancingEntity financing:
        await _expensesSource.updateQuery(
          commonId: commonId,
          object: financing.toDto(),
        );
    }
  }
}
