...
mixin _$ExpenseDbDto {
 ...
 String get name; MaxiPocketExpensesType get eventType; DateTime get eventDate;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExpenseDbDto&&(identical(other.name, name) || other.name == name)&&(identical(other.eventType, eventType) || other.eventType == eventType)&&(identical(other.eventDate, eventDate) || other.eventDate == eventDate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,eventType,eventDate);

@override
String toString() {
  return 'ExpenseDbDto(name: $name, eventType: $eventType, eventDate: $eventDate)';
}
...
@useResult
$Res call({
 String name, MaxiPocketExpensesType eventType, DateTime eventDate
});
...
/// Create a copy of ExpenseDbDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? eventType = null,Object? eventDate = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  MaxiPocketExpensesType eventType,  DateTime eventDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExpenseDbDto() when $default != null:
return $default(_that.name,_that.eventType,_that.eventDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  MaxiPocketExpensesType eventType,  DateTime eventDate)  $default,) {final _that = this;
switch (_that) {
case _ExpenseDbDto():
return $default(_that.name,_that.eventType,_that.eventDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  MaxiPocketExpensesType eventType,  DateTime eventDate)?  $default,) {final _that = this;
switch (_that) {
case _ExpenseDbDto() when $default != null:
return $default(_that.name,_that.eventType,_that.eventDate);case _:
  return null;
...
class _ExpenseDbDto extends ExpenseDbDto {
  const _ExpenseDbDto({required this.name, required this.eventType, required this.eventDate}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExpenseDbDto&&(identical(other.name, name) || other.name == name)&&(identical(other.eventType, eventType) || other.eventType == eventType)&&(identical(other.eventDate, eventDate) || other.eventDate == eventDate));
}
...
/// Create a copy of ExpenseDbDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? eventType = null,Object? eventDate = null,}) {
