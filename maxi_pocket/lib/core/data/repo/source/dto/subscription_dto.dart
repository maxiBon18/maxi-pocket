...
/// DTO for a subscription expense, embedding shared fields via [ExpenseDbDto].
@Freezed()
abstract class SubscriptionDto with _$SubscriptionDto implements ExpenseDbInsertDto {
  ...
  SubscriptionEntity toEntity() =>
      SubscriptionEntity(commitmentEntity: expense.toEntity(), amount: amount, frequency: frequency);
}
