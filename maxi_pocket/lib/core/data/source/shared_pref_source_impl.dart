...
class SharedPrefAsyncSourceImpl implements SharedPrefAsyncSource {
  ...
  Future<String?> getStringAsync(String key) async =>
      await _sharedPreferencesAsync.getString(key);

  @override
  Future<int?> getIntAsync(String key) async =>
      await _sharedPreferencesAsync.getInt(key);

  @override
  Future<double?> getDoubleAsync(String key) async =>
      await _sharedPreferencesAsync.getDouble(key);

  @override
  Future<bool?> getBoolAsync(String key) async =>
      await _sharedPreferencesAsync.getBool(key);

  @override
  Future<List<String>?> getStringListAsync(String key) async =>
      await _sharedPreferencesAsync.getStringList(key);

  @override
  Future<Map<String, Object?>> getAllAsync() async =>
      await _sharedPreferencesAsync.getAll();

  @override
  Future<Set<String>> getKeysAsync() async =>
      await _sharedPreferencesAsync.getKeys();
...
class SharedPrefWithCacheSourceImpl implements SharedPrefWithCacheSource {
  ...
  String? getStringWithCache(String key) =>
      _sharedPreferencesWithCache.getString(key);
  ...
  double? getDoubleWithCache(String key) =>
      _sharedPreferencesWithCache.getDouble(key);

  @override
  bool? getBoolWithCache(String key) =>
      _sharedPreferencesWithCache.getBool(key);

  @override
  List<String>? getStringListWithCache(String key) =>
      _sharedPreferencesWithCache.getStringList(key);
