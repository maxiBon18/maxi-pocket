  ...
  Color _getTextColor() {
    ...
    if (expType != null) {
      return switch (expType) {
        ...
        MaxiPocketExpensesType.all => ThemeLightColors.errorColor,
    ...
    if (expFreq != null) {
      return switch (expFreq) {
        MaxiPocketExpensesFrequency.monthly =>
          ThemeLightColors.textMonthlyColor,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.symmetric(
        ...
        vertical: DesignConstants.spacing4,
      ),
      decoration: BoxDecoration(
        color: _getBackgroundColor(),
        shape: BoxShape.rectangle,
        borderRadius: const BorderRadius.all(
          Radius.circular(DesignConstants.radius40),
        ),
      ),
      height: screenHeight
          .responsiveHeight(DesignConstants.containerSize24)
