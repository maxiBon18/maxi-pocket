    ...
    return Row(
      ...
      children: <Widget>[
        MaxiPocketBulletPointWidget(
          color: isAppointment
              ? ThemeDarkColors.appointmentsBulletPointColor
        ...
        Flexible(
          child: Text(
            ...
            style: ThemeTextStyles.appLightTextTheme.titleSmall?.copyWith(
              color: _textColor,
            ),
          ),
        ),
...
class _RecapAmountText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      isAppointment
          ? ''
          : '${amount?.toStringAsFixed(2) ?? '0.00'} ${WidgetConstants.currencySymbol}',
      style:
