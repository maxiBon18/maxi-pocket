...
class MaxiPocketNavigatorObserver extends NavigatorObserver {
  ...
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    _logger.t('Custom Navigator Class => didPush from ${previousRoute?.settings.name} to ${route.settings.name}');
  ...
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    _logger.t('Custom Navigator Class => didPop from ${route.settings.name} to ${previousRoute?.settings.name}');
  ...
  void didRemove(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    _logger.t('Custom Navigator Class => didRemove from ${previousRoute?.settings.name} to ${route.settings.name}');
    _routesStack.remove(route);
  }
  ...
  void didReplace({Route<dynamic>? newRoute, Route<dynamic>? oldRoute}) {
    ...
    _logger.t('Custom Navigator Class => didReplace from ${oldRoute?.settings.name} to ${newRoute?.settings.name}');
