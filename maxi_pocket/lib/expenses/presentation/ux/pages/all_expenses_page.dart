...
class MaxiPocketAllExpensesPage extends ConsumerWidget {
  ...
  Future<void> _onDelete(
    ...
    final (BigInt id, MaxiPocketExpensesType type)? idAndType =
        switch (entity) {
          final SubscriptionEntity s when s.id != null => (
            s.id!,
            MaxiPocketExpensesType.subscription,
          ),
          final FinancingEntity f when f.id != null => (
            f.id!,
    ...
    await showAlertDialog(
      ...
      onConfirm: () async {
        ...
        await ref
            ...
            .deleteCommitment(commonId: idAndType.$1, type: idAndType.$2);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaxiPocketPage(
      ...
      title: MaxiPocketAppBarTitle(
        title: ExpensesWidgetConstants.allExpensesTitle,
        themeMode: themeMode,
      ),
      child: expenses.when(
        data: (HomeEntity data) => MaxiPocketTabBarExpensesWidget(
          ...
          numberOfMonthlyExpenses: ref
              ...
              .numberOfMonthlyExpenses,
          numberOfYearlyExpenses: ref
              .read(expensesrProvider.notifier)
              .numberOfYearlyExpenses,
          totalAmountOfMonthlyExpenses: ref
              .read(expensesrProvider.notifier)
              .getTotalAmountOfMonthlyExpenses(data),
          totalAmountOfYearlyExpenses: ref
              .read(expensesrProvider.notifier)
              .getTotalAmountOfYearlyExpenses(data),
