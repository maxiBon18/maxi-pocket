    ...
    await showAlertDialog(
      ...
      onConfirm: () async {
        ...
        await ref
            ...
            .deleteCommitment(commonId: entity.id!, type: MaxiPocketExpensesType.subscription);
    ...
    return MaxiPocketPage(
      ...
      child: expenses.when(
        data: (HomeEntity data) => MaxiPocketTabBarExpensesWidget(
          themeMode: themeMode,
          numberOfMonthlyExpenses: ref.read(expensesrProvider.notifier).numberOfMonthlySubscriptions,
          numberOfYearlyExpenses: ref.read(expensesrProvider.notifier).numberOfYearlySubscriptions,
          totalAmountOfMonthlyExpenses: ref.read(expensesrProvider.notifier).getTotalAmountOfMonthlySubscriptions(data),
          totalAmountOfYearlyExpenses: ref.read(expensesrProvider.notifier).getTotalAmountOfYearlySubscriptions(data),
          entityToShow: getHomeWrapperCommitments(data, MaxiPocketExpensesType.subscription),
