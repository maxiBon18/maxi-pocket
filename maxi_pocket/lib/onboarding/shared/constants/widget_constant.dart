...
class OnboardingWidgetConstants {
  ...
  static const String onboardingTitle = 'Mantieni il controllo';
  ...
  static const String onboardingNotificationContainerTitle = 'Non perderti nessun pagamento';
  ...
  /// Title inside the notification info container card.
  static const String onboardingNotificationAppointmentsContainerTitle = 'Non mancare nessuna data';
...
class OnboardingAssetsConstants {
  ...
  static const String notificationIcon = 'assets/images/onboarding_notification_container.png';

  /// Illustration displayed in the appointments notification info container on the onboarding page.
  static const String notificationAppointmentsIcon = 'assets/images/scheduled_notification_image.png';
}
