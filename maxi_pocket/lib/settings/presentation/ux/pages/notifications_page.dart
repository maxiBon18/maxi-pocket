...
import 'package:maxi_pocket/core/shared/utils/methods.dart' show getListTileBorderColor, getShadowsColor;
...
class _NotificationsHeaderWidget extends StatelessWidget {
  const _NotificationsHeaderWidget({required this.themeMode, required this.responsiveIconSize});
