...
class MaxiPocketThemePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final double responsiveIconSize = screenHeight.responsiveHeight(DesignConstants.containerSize80);
...
class _ThemeHeaderWidget extends StatelessWidget {
  const _ThemeHeaderWidget({required this.themeMode, required this.responsiveIconSize});
...
class _ThemeSwitchTileWidget extends StatelessWidget {
  const _ThemeSwitchTileWidget({required this.themeMode, required this.ref});
    ...
    return MaxiPocketListTileWidget(
      ...
      trailing: MaxiPocketSwitchWidget(
        ...
        onChanged: (bool? value) {
          if (value != null) {
            ref.read(themeProvider.notifier).setThemeMode(value ? MaxiPocketThemeMode.dark : MaxiPocketThemeMode.light);
          }
        },
      ),
      themeMode: themeMode,
