...
import 'package:maxi_pocket/splashscreen/shared/constants/design_constants.dart' show MaxiPocketSplashDesignConstants;
...
Timer createSplashTimer(VoidCallback onComplete) =>
    Timer(const Duration(seconds: MaxiPocketSplashDesignConstants.splashDuration), onComplete);
